...
enrichment-battery  & 32$^{*}$ & 32$^{*}$ & 0 \\
mapping-matrix      & 24  & 24  & 0 \\
fragility-lookup    & 10  & 10  & 0 \\
\midrule
\textbf{Total}      & \textbf{124} & \textbf{124} & \textbf{0} \\
\botrule
\end{tabular*}
\begin{tablenotes}
